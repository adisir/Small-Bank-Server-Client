...
void* writeToServer(){
	...
	while(1){
		printf("\n");
		printf("Commands:\n create <Account Name> : to open an account\n serve <Account Name> : to start an account session\n withdraw <Amount> : to withdraw from an account\n deposit <Amount> : to deposit to an account\n query: to find out what your balance is \n end : to leave an account session\n quit : to disconnect from the server\n");
		printf("NOTE:\n You must be within an account session to deposit and withdraw an account\n");
